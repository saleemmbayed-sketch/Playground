...
export const config = {
  ...
  mail: {
    ...
    /** Where the 'outbox' transport writes .eml files. Overridable so tests and
     *  parallel environments do not read each other's mail. */
    outboxDir: process.env.MAIL_OUTBOX_DIR ?? 'data/outbox',
